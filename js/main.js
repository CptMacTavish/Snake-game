...
function drawSnake() {
    snake.forEach((segment) => {
        const snakeElement = createGameElementh('div', 'snake')
...
function createGameElementh(tag, className) {
...
function drawFood() {
    if (gameStarted){
        const foodElement = createGameElementh('div', 'food');
...
function stopGame() {
    ...
    instuctionText.innerText = 'GAME OVER'
